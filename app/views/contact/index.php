            ...
            <div class="row g-5 justify-content-center">
                <div class="col-lg-5 col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-secondary text-white d-flex flex-column justify-content-center h-100 p-5">
                        ...
                        <p class="mb-5"><i class="fa fa-map-marker-alt me-3"></i>28E Tăng Bạt Hổ, Phường 11, Bình Thạnh,
                ...
                <div class="col-lg-7 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn btn-secondary rounded-pill py-3 px-5" type="submit">Gửi tin
                                    nhắn</button>
                            </div>
                        </div>
                    </form>
