                    ...
                    <div class="card-body">
                        ...
                        <form action="/admin/registerAdmin" method="post" id='form-register-admin' onsubmit="return validateForm()">
                            <div class="mb-3">
                                ...
                                <input required name="name" type="text" class="form-control" id="inputtext1" aria-describedby="textHelp">
                                <span id="nameError"></span>
                            </div>
                            <div class="mb-3">
                                <label for="inputEmail1" class="form-label">Email Address</label>
                                <input required name="email" type="email" class="form-control" id="inputEmail1" aria-describedby="emailHelp">
